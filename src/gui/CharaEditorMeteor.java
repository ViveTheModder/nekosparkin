package gui;
//Nekosparkin: Character Editor (BT3) class by ViveTheJoestar
...
public class CharaEditorMeteor {
	...
	throws IOException {
		...
		int searchResult = CsvHandler.getCsvSearchResult(csvs, "chara", false);
		...
		searchResult = CsvHandler.getCsvSearchResult(csvs, "item", false);
